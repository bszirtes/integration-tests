...
func (s *Suite) SetupSuite() {
	...
	r.Run(`curl https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/v0.1.13/apps/nsc-simple-docker/docker-compose.yaml -o docker-compose.yaml`)
